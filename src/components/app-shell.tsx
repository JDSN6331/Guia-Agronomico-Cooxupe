...
const NAV = [
  ...
  { to: "/milho-soja", label: "Milho e Soja", icon: Sprout },
  { to: "/foliar", label: "Linha Foliar", icon: TestTube2 },
  { to: "/calendario", label: "Calendário de Manejo", icon: CalendarRange },
] as const;
...
export function AppShell({
  ...
  const itens = isAdmin ? [...NAV, { to: "/usuarios", label: "Usuários", icon: Users }] : [...NAV];
    ...
    <div className="flex min-h-screen w-full bg-background">
      <aside className="sticky top-0 hidden h-screen w-64 shrink-0 flex-col border-r border-sidebar-border bg-sidebar px-3 py-4 lg:flex">
        ...
        <div className="mt-auto rounded-xl bg-sidebar-accent/60 p-3 text-xs leading-relaxed text-sidebar-accent-foreground">
          <p className="font-semibold">Programa de Uso 2026</p>
