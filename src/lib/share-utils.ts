  ...
  const conteudoHtml = `
    ...
    <head>
      ...
      <style>
        ...
        .footer { margin-top: 40px; border-top: 1px solid #ddd; pt-10px; font-size: 11px; color: #777; text-align: center; }
      </style>
    </head>
    <body>
      <div class="header">
      ...
      <div class="footer">
        Ficha emitida via AgroBase — Uso interno do time de Desenvolvimento Técnico.
      </div>
